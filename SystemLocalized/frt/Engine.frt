...
Preferences=(Caption="Advanced",Parent="Options Avancées")
; EN: Preferences=(Caption="Rendering",Parent="Advanced Options")
Preferences=(Caption="Rendering",Parent="Options Avancées")
...
Preferences=(Caption="Networking",Parent="Options Avancées")
; EN: Preferences=(Caption="Game Types",Parent="Advanced Options")
Preferences=(Caption="Game Types",Parent="Options Avancées")
; EN: Preferences=(Caption="Display",Parent="Advanced Options")
Preferences=(Caption="Display",Parent="Options Avancées")
...
Preferences=(Caption="Drivers",Parent="Options Avancées",Class=Engine.Engine,Immediate=False,Category=Drivers)
; EN: Preferences=(Caption="Game Settings",Parent="Advanced Options",Class=Engine.GameInfo,Immediate=True)
Preferences=(Caption="Game Settings",Parent="Options Avancées",Class=Engine.GameInfo,Immediate=True)
; EN: Preferences=(Caption="Decals",Parent="Advanced Options")
Preferences=(Caption="Decals",Parent="Options Avancées")
; Advanced
