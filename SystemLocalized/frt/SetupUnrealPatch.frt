...
Description="Copie tous les fichiers nécessaires pour le fonctionnement d'Unreal sous Linux. Les options avancées ne sont pas disponibles dans le menu mais peuvent être modifiées manuellement en éditant le fichier UnrealLinux.ini. UnrealEd 2.1 n'est pas disponible sous Linux. Si vous rencontrez des problèmes, des informations et une FAQ sont disponibles dans les ReleaseNotes du dossier Help. Si votre système ne possède pas les librairies requises, une archive lin_convenience_libs.7z dans le dossier Help devrait contenir tous les fichiers nécessaires."
...
Caption="Correctif coop Return to Na Pali"
...
Description="Copie les fichiers du mutator UPakFix. Ces fichiers permettent de jouer au multijoueurs coopératif de Unreal: Return to Na Pali sans les problèmes habituels."
