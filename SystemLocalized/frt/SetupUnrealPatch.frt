...
Description="Copie tous les fichiers nécessaires pour le fonctionnement d'Unreal sous Linux. Les Options Avancées ne sont pas disponibles dans le menu mais peuvent être modifiées manuellement en éditant le fichier UnrealLinux.ini. UnrealED n'est pas disponible sous Linux. Si vous rencontrez des problèmes, des informations et une FAQ sont disponibles dans les ReleaseNotes du dossier Help. Si votre système ne possède pas les librairies requises, une archive lin_convenience_libs.tar.bz2 dans le dossier Help devrait contenir tous les fichiers nécessaires."
