...
HUDScaleHelp="Spécifie le niveau de mise à l'échelle du HUD en jeu."
...
ShadowDistanceHelp="Spécifie la distance d'affichage des ombres en temps réel des pions/décorations."
; EN: ShadowDistanceOpts[0]="Short (-50 %)"
ShadowDistanceOpts[0]="Court (-50 %)"
...
ShowSpecularHelp="Si coché, permet au jeu de rendre les maillages avec un éclairage de style ancien."
...
SkyFogText="Ciel Embué"
; EN: SkyFogHelp="Changes how volumetric fog is being rendered on skybox."
SkyFogHelp="Change le rendu du brouillard volumétrique sur la skybox."
...
LightLODHelp="Modifie le niveau de détail de l'éclairage sur le monde du jeu. Une valeur inférieure réduira la fréquence d'images de l'éclairage sur les scènes complexes."
...
HighSkillWarning="Ce niveau de compétence est destiné à être joué en mode coopératif et ne correspond pas aux paramètres de difficulté standard. Vous êtes assuré d'être brutalisé si vous tentez de faire une course en solo sur l'une de ces difficultés. Êtes-vous sûr de vouloir continuer ?"
...
; EN: UseClassicHelp="If checked, some gameplay mechanics will behave like those from old Unreal versions."
UseClassicHelp="Si cette case est cochée, certains mécanismes de jeu se comporteront comme ceux des anciennes versions d'Unreal."
