...
; "Editor" tree
Preferences=(Caption="Editor",Parent="Advanced Options",LangCaption="Editeur")
Preferences=(Caption="Advanced (Editor)",Parent="Editor",LangCaption="Avancées (Editeur)",Class=Editor.EditorEngine,Immediate=True,Category=Advanced)
Preferences=(Caption="Colors",Parent="Editor",LangCaption="Couleurs",Class=Editor.EditorEngine,Immediate=True,Category=Colors)
Preferences=(Caption="Grid",Parent="Editor",LangCaption="Grille",Class=Editor.EditorEngine,Immediate=True,Category=Grid)
Preferences=(Caption="Rotation Grid",Parent="Editor",LangCaption="Grille de Rotation",Class=Editor.EditorEngine,Immediate=True,Category=RotationGrid)
; "Commandlets and Exporters" subtree
Preferences=(Caption="Commandlets and Exporters",Parent="Editor",LangCaption="Applicommandes et Exportateurs")
Preferences=(Caption="AudioPackage Commandlet",Parent="Commandlets and Exporters",LangCaption="Applicommande AudioPackage",Class=Editor.AudioPackageCommandlet,Immediate=True)
Preferences=(Caption="BatchMeshExport Commandlet",Parent="Commandlets and Exporters",LangCaption="Applicommande BatchMeshExport",Class=Editor.BatchMeshExportCommandlet,Immediate=True)
Preferences=(Caption="FullBatchExport Commandlet",Parent="Commandlets and Exporters",LangCaption="Applicommande FullBatchExport",Class=Editor.FullBatchExportCommandlet,Immediate=True)
Preferences=(Caption="MusicPackages Commandlet",Parent="Commandlets and Exporters",LangCaption="Applicommande MusicPackages",Class=Editor.MusicPackagesCommandlet,Immediate=True)
Preferences=(Caption="RebuildImports Commandlet",Parent="Commandlets and Exporters",LangCaption="Applicommande RebuildImports",Class=Editor.RebuildImportsCommandlet,Immediate=True)
Preferences=(Caption="SkeletalAnim (PSA) Exporter",Parent="Commandlets and Exporters",LangCaption="Exportateur SkeletalAnim (PSA)",Class=Editor.SkeletalAnimExpPSA,Immediate=True)
