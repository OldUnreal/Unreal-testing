...
Preferences=(Caption="Advanced",Parent="Opcje Zaawansowane")
...
Preferences=(Caption="Networking",Parent="Opcje Zaawansowane")
; EN: Preferences=(Caption="Game Types",Parent="Advanced Options")
Preferences=(Caption="Game Types",Parent="Opcje Zaawansowane")
; EN: Preferences=(Caption="Display",Parent="Advanced Options")
Preferences=(Caption="Display",Parent="Opcje Zaawansowane")
; EN: Preferences=(Caption="Joystick",Parent="Advanced Options")
Preferences=(Caption="Joystick",Parent="Opcje Zaawansowane")
; EN: Preferences=(Caption="Drivers",Parent="Advanced Options",Class=Engine.Engine,Immediate=False,Category=Drivers)
Preferences=(Caption="Drivers",Parent="Opcje Zaawansowane",Class=Engine.Engine,Immediate=False,Category=Drivers)
; EN: Preferences=(Caption="Game Settings",Parent="Advanced Options",Class=Engine.GameInfo,Immediate=True)
Preferences=(Caption="Game Settings",Parent="Opcje Zaawansowane",Class=Engine.GameInfo,Immediate=True)
; EN: Preferences=(Caption="Decals",Parent="Advanced Options")
Preferences=(Caption="Decals",Parent="Opcje Zaawansowane")
; Advanced
