...
Hint="Zanurkuj w stawie i poszukaj ukrytego przejścia."

[TranslatorEvent12]
; EN: Message=""...For that will be the key""
Message=""...albowiem to ono będzie kluczem.""
; EN: Hint="Activate the lever to let the water run."
Hint="Przesuń dźwignię, aby popłynęła woda."

[TranslatorEvent13]
; EN: Message="You must have a keen eye, so that you may bathe in the sacred waters."
Message="Tylko ci, którzy mają bystre spojrzenie, mogą dostąpić zaszczytu kąpieli w tych świętych wodach."
; EN: Hint="Look at each face."
Hint="Przyjrzyj się każdej twarzy."

[TranslatorEvent11]
; EN: Message=""Wood must break free...""
Message=""Drzewo musi zostać uwolnione...""
; EN: Hint="Activate the lever to let the water run."
Hint="Przesuń dźwignię, aby popłynęła woda."
...
Message="Tylko ci, którzy mają serca czyste niczym kryształ, mogą oddać cześć Bogu Mądrości, Chizrze"
; EN: Hint="Activate the lever to let the water run."
Hint="Przesuń dźwignię, aby popłynęła woda."
