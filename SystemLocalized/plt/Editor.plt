...
; "Editor" tree
Preferences=(Caption="Editor",Parent="Advanced Options",LangCaption="Edytor")
Preferences=(Caption="Advanced (Editor)",Parent="Editor",LangCaption="Zaawansowane (Edytor)",Class=Editor.EditorEngine,Immediate=True,Category=Advanced)
Preferences=(Caption="Colors",Parent="Editor",LangCaption="Kolory",Class=Editor.EditorEngine,Immediate=True,Category=Colors)
Preferences=(Caption="Grid",Parent="Editor",LangCaption="Siatka",Class=Editor.EditorEngine,Immediate=True,Category=Grid)
Preferences=(Caption="Rotation Grid",Parent="Editor",LangCaption="Siatka Rotacyjna",Class=Editor.EditorEngine,Immediate=True,Category=RotationGrid)
; "Commandlets and Exporters" subtree
Preferences=(Caption="Commandlets and Exporters",Parent="Editor",LangCaption="Aplikacje i Eksporterzy")
Preferences=(Caption="AudioPackage Commandlet",Parent="Commandlets and Exporters",LangCaption="Aplikacje AudioPackage",Class=Editor.AudioPackageCommandlet,Immediate=True)
Preferences=(Caption="BatchMeshExport Commandlet",Parent="Commandlets and Exporters",LangCaption="Aplikacje BatchMeshExport",Class=Editor.BatchMeshExportCommandlet,Immediate=True)
Preferences=(Caption="FullBatchExport Commandlet",Parent="Commandlets and Exporters",LangCaption="Aplikacje FullBatchExport",Class=Editor.FullBatchExportCommandlet,Immediate=True)
Preferences=(Caption="MusicPackages Commandlet",Parent="Commandlets and Exporters",LangCaption="Aplikacje MusicPackages",Class=Editor.MusicPackagesCommandlet,Immediate=True)
Preferences=(Caption="RebuildImports Commandlet",Parent="Commandlets and Exporters",LangCaption="Aplikacje RebuildImports",Class=Editor.RebuildImportsCommandlet,Immediate=True)
Preferences=(Caption="SkeletalAnim (PSA) Exporter",Parent="Commandlets and Exporters",LangCaption="Eksporter SkeletalAnim (PSA)",Class=Editor.SkeletalAnimExpPSA,Immediate=True)
