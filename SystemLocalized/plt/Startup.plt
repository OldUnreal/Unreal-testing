...
OpenGLDrv.OpenGLRenderDevice="Obsługa standardu OpenGL. Zapewnia najlepszą wydajność i wsparcie dla najnowszych modeli kart graficznych. Obsługuje tekstury w wysokiej rozdzielczości. Wymagana jest karta graficzna obsługująca OpenGL 2.1 lub nowszy."
...
XOpenGLDrv.XOpenGLRenderDevice="Wykorzystuje nowoczesną obsługę OpenGL dla Unreal (XOpenGL). XOpenGL wykorzystuje funkcje z OpenGL 3.3-4.6. Zapewnia obsługę nowoczesnych kart graficznych wysokiej klasy i oferuje nowe funkcje, takie jak mapowanie normalnych i mapowanie paralaksy (które wymagają nowych lub dodatkowych tekstur). Obsługa tekstur w wysokiej rozdzielczości. Wymagana jest karta graficzna obsługująca OpenGL 3.3 lub nowszy."
...
ALAudio.ALAudioSubsystem="Zaawansowana obsługa standardu OpenAL. Zapewnia najlepszą wydajność i wsparcie dla najnowszych modeli kart dźwiękowych. Obsługuje standard EAX/EFX. Najnowsze sterowniki do karty dźwiękowej zalecane."
