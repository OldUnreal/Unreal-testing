...
Object=(Name=UMenu.UnrealConsole,Class=Class,MetaClass=Engine.Console,Description="UMenu (Windows-podobny)")
...
DriverHelp="Obecny sterownik obrazu. Naciśnij przycisk Uruchom ponownie aby potwierdzić zmianę."
...
HUDScaleText="Skalowanie HUD"
; EN: HUDScaleHelp="Specifies the scaling level of the in-game HUD."
HUDScaleHelp="Określa poziom skalowania interfejsu w grze."
...
; EN: ShadowDistanceHelp="Specifies the draw distance of pawn/decoration real-time shadows."
ShadowDistanceHelp="Określa odległość rysowania cieni pionków/dekoracji w czasie rzeczywistym."
; EN: ShadowDistanceOpts[0]="Short (-50 %)"
ShadowDistanceOpts[0]="Krótki (-50%)"
...
; EN: ShowSpecularText="Specular Lights"
ShowSpecularText="Światła zwierciadlane"
; EN: ShowSpecularHelp="If checked, allows the game to render meshes with old style lighting."
ShowSpecularHelp="Jeżeli zaznaczone, pozwala grze na renderowanie siatek z oświetleniem w starym stylu."
...
FovAngleText="Pole widzenia"
; EN: FovAngleHelp="Horizontal FOV (field of view) angle in degrees"
FovAngleHelp="Poziomy kąt FOV (pola widzenia) w stopniach"
...
UsePrecacheText="Wstępne ładowanie"
; EN: UsePrecacheHelp="Use this option for precaching map content (such as sounds and textures)."
UsePrecacheHelp="Zaznacz aby wstępnie przygotować zawartość mapy (taką jak dźwięki i tekstury)."
...
AnisotropicFilteringModes[0]="Wyłączone"
...
AntialiasingModes[0]="Wyłączone"
; EN: AntialiasingModes[1]="On"
AntialiasingModes[1]="Włączone"
...
; EN: SkyFogText="Sky fogging"
SkyFogText="Zamglenie nieba"
; EN: SkyFogHelp="Changes how volumetric fog is being rendered on skybox."
SkyFogHelp="Zmienia sposób renderowania wolumetrycznej mgły na skyboxie."
; EN: LightLODText="Lightmap LOD"
LightLODText="Szczegółowość oświetlenia"
; EN: LightLODHelp="Changes the lighting LOD (level of detail) aggressiveness on the game's world. A lower value will cut down lighting framerate on complex scenes."
LightLODHelp="Zmienia agresywność oświetlenia LOD (poziom szczegółowości) w świecie gry. Niższa wartość zmniejszy liczbę klatek na sekundę oświetlenia w złożonych scenach."
...
bMouseSmoothHelp="Jeśli ta opcja jest zaznaczona, sygnał z myszy będzie wygładzany, aby poprawić płynność działania Patrzenie myszą."
; EN: MouseSmoothText="Max Smoothing"
MouseSmoothText="Maks. wygładzanie"
; EN: MouseSmoothHelp="If checked, mouse input will be smoothed more to improve Mouselook smoothness."
MouseSmoothHelp="Jeśli ta opcja jest zaznaczona, sygnał z myszy będzie bardziej wygładzany, aby poprawić płynność rozglądania myszą."
...
RawHIDInputHelp="Włączenie Raw HID Input na komputerach z Windowsem poprawi płynność działania myszy i nie wpływa na nią przyspieszenie myszy. Wymaga restartu gry."
...
DodgeClickTimeText="Czas dwukliku do uniku"
; EN: DodgeClickTimeHelp="Maximal double click interval in seconds for dodge move."
DodgeClickTimeHelp="Maksymalny interwał dwukrotnego kliknięcia w sekundach aby wykonać unik."
...
; EN: HighSkillWarning="This skill level is meant to be played on Cooperative mode, and falls outside standard difficulty settings. You're guaranteed to be brutalized if you attempt to do a solo run on one of these difficulties. Are you sure you want to proceed?"
HighSkillWarning="Ten poziom umiejętności jest przeznaczony do gry w trybie współpracy i wykracza poza standardowe ustawienia trudności. Masz gwarancję, że zostaniesz brutalnie potraktowany, jeśli spróbujesz wykonać bieg solo na jednym z tych poziomów trudności. Czy na pewno chcesz kontynuować ?"
...
; EN: UseClassicText="Classic Balance"
UseClassicText="Klasycznego Balansu"
; EN: UseClassicHelp="Specifies if some gameplay mechanics should behave as old Unreal versions."
UseClassicHelp="Jeśli zaznaczone, niektóre mechanizmy rozgrywki będą zachowywać się jak te ze starych wersji Unreal."
...
ConfirmText="Ta opcja uruchomi teraz ponownie Unreal i sprawi że będzie działać z wybranymi ustawieniami. Czy chcesz to zrobić?"
; EN: ConfirmTitle="Save Settings and Restart..."
ConfirmTitle="Zapisz ustawienia i restartuj..."
...
DebugModeHelp="Włącz tryb debugowania UWindow."
...
AboutHelp="Zobacz napisy o tym, kto stworzył Unreal."
...
FriendlyFireText="Bratobójczy ogień"
...
ClassCaption="UMenu (Windows-podobny)"
