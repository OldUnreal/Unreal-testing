...
HUDScaleHelp="Dostosuj rozmiar interfejsu w grze (HUD)."
...
ShadowDistanceHelp="Odległość rysowania cieni postaci/dekoracji w czasie rzeczywistym."
...
UseClassicText="Użyj Klasycznego Balansu"
