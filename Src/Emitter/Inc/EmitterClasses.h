...
{
public:
	FVector BoundsMin GCC_PACK(INT_ALIGNMENT);
	FVector BoundsMax;
...
//VERIFY_CLASS_OFFSET_NODIE(A,XRainRestrictionVolume,BoundsMin)
//VERIFY_CLASS_OFFSET_NODIE(A,XRainRestrictionVolume,BoundsMax)
VERIFY_CLASS_SIZE_NODIE(AXRainRestrictionVolume)
//VERIFY_CLASS_OFFSET_NODIE(A,XWeatherEmitter,ParticleCount)
//VERIFY_CLASS_OFFSET_NODIE(A,XWeatherEmitter,NextParticleTime)
//VERIFY_CLASS_OFFSET_NODIE(A,XWeatherEmitter,SpawnInterval)
//VERIFY_CLASS_OFFSET_NODIE(A,XWeatherEmitter,WallHitMinZ)
//VERIFY_CLASS_OFFSET_NODIE(A,XWeatherEmitter,SheetModel)
//VERIFY_CLASS_OFFSET_NODIE(A,XWeatherEmitter,RainVolume)
//VERIFY_CLASS_OFFSET_NODIE(A,XWeatherEmitter,WallHitEmitter)
//VERIFY_CLASS_OFFSET_NODIE(A,XWeatherEmitter,RainVolumeTag)
//VERIFY_CLASS_OFFSET_NODIE(A,XWeatherEmitter,WaterHitEmitter)
//VERIFY_CLASS_OFFSET_NODIE(A,XWeatherEmitter,NoRainBounds)
//VERIFY_CLASS_OFFSET_NODIE(A,XWeatherEmitter,WallHitEmitters)
//VERIFY_CLASS_OFFSET_NODIE(A,XWeatherEmitter,WaterHitEmitters)
//VERIFY_CLASS_OFFSET_NODIE(A,XWeatherEmitter,PartTextures)
//VERIFY_CLASS_OFFSET_NODIE(A,XWeatherEmitter,LastCamPosition)
//VERIFY_CLASS_OFFSET_NODIE(A,XWeatherEmitter,VecArea)
//VERIFY_CLASS_OFFSET_NODIE(A,XWeatherEmitter,CachedCoords)
//VERIFY_CLASS_OFFSET_NODIE(A,XWeatherEmitter,TransfrmCoords)
//VERIFY_CLASS_OFFSET_NODIE(A,XWeatherEmitter,Position)
//VERIFY_CLASS_OFFSET_NODIE(A,XWeatherEmitter,AppearArea)
//VERIFY_CLASS_OFFSET_NODIE(A,XWeatherEmitter,ParticlesColor)
//VERIFY_CLASS_OFFSET_NODIE(A,XWeatherEmitter,Lifetime)
//VERIFY_CLASS_OFFSET_NODIE(A,XWeatherEmitter,speed)
//VERIFY_CLASS_OFFSET_NODIE(A,XWeatherEmitter,Size)
//VERIFY_CLASS_OFFSET_NODIE(A,XWeatherEmitter,FadeOutDistance)
//VERIFY_CLASS_OFFSET_NODIE(A,XWeatherEmitter,WallHitEvent)
//VERIFY_CLASS_OFFSET_NODIE(A,XWeatherEmitter,WaterHitEvent)
//VERIFY_CLASS_OFFSET_NODIE(A,XWeatherEmitter,AppearAreaType)
//VERIFY_CLASS_OFFSET_NODIE(A,XWeatherEmitter,WeatherType)
//VERIFY_CLASS_OFFSET_NODIE(A,XWeatherEmitter,PartStyle)
VERIFY_CLASS_SIZE_NODIE(AXWeatherEmitter)
//VERIFY_CLASS_OFFSET_NODIE(A,XParticleEmitter,ActiveCount)
//VERIFY_CLASS_OFFSET_NODIE(A,XParticleEmitter,PartCombiners)
VERIFY_CLASS_SIZE_NODIE(AXParticleEmitter)
//VERIFY_CLASS_OFFSET_NODIE(U,TrailEmitterRender,Owner)
//VERIFY_CLASS_OFFSET_NODIE(U,TrailEmitterRender,Particle)
VERIFY_CLASS_SIZE_NODIE(UTrailEmitterRender)
VERIFY_CLASS_SIZE_NODIE(AXTrailParticle)
//VERIFY_CLASS_OFFSET_NODIE(A,XTrailEmitter,TrailTreshold)
//VERIFY_CLASS_OFFSET_NODIE(A,XTrailEmitter,MaxTrailLength)
//VERIFY_CLASS_OFFSET_NODIE(A,XTrailEmitter,TextureUV)
//VERIFY_CLASS_OFFSET_NODIE(A,XTrailEmitter,TexOffset)
//VERIFY_CLASS_OFFSET_NODIE(A,XTrailEmitter,ParticleData)
//VERIFY_CLASS_OFFSET_NODIE(A,XTrailEmitter,trail)
//VERIFY_CLASS_OFFSET_NODIE(A,XTrailEmitter,SheetUpdir)
//VERIFY_CLASS_OFFSET_NODIE(A,XTrailEmitter,OldTrailSpot)
//VERIFY_CLASS_OFFSET_NODIE(A,XTrailEmitter,TrailType)
VERIFY_CLASS_SIZE_NODIE(AXTrailEmitter)
//VERIFY_CLASS_OFFSET_NODIE(A,XEmitter,MaxParticles)
//VERIFY_CLASS_OFFSET_NODIE(A,XEmitter,SingleIVert)
//VERIFY_CLASS_OFFSET_NODIE(A,XEmitter,NextParticleTime)
//VERIFY_CLASS_OFFSET_NODIE(A,XEmitter,SpawnInterval)
//VERIFY_CLASS_OFFSET_NODIE(A,XEmitter,ResetTimer)
//VERIFY_CLASS_OFFSET_NODIE(A,XEmitter,ParticlesPerSec)
//VERIFY_CLASS_OFFSET_NODIE(A,XEmitter,LODFactor)
//VERIFY_CLASS_OFFSET_NODIE(A,XEmitter,FadeInTime)
//VERIFY_CLASS_OFFSET_NODIE(A,XEmitter,FadeOutTime)
//VERIFY_CLASS_OFFSET_NODIE(A,XEmitter,FadeInMaxAmount)
//VERIFY_CLASS_OFFSET_NODIE(A,XEmitter,PartSpriteForwardZ)
//VERIFY_CLASS_OFFSET_NODIE(A,XEmitter,CullDistance)
//VERIFY_CLASS_OFFSET_NODIE(A,XEmitter,CullDistanceFadeDist)
//VERIFY_CLASS_OFFSET_NODIE(A,XEmitter,HittingActorKickVelScale)
//VERIFY_CLASS_OFFSET_NODIE(A,XEmitter,MinBounceVelocity)
//VERIFY_CLASS_OFFSET_NODIE(A,XEmitter,MinImpactVelForSnd)
//VERIFY_CLASS_OFFSET_NODIE(A,XEmitter,CoronaFadeTimeScale)
//VERIFY_CLASS_OFFSET_NODIE(A,XEmitter,CoronaMaxScale)
//VERIFY_CLASS_OFFSET_NODIE(A,XEmitter,CoronaScaling)
//VERIFY_CLASS_OFFSET_NODIE(A,XEmitter,MaxCoronaDistance)
//VERIFY_CLASS_OFFSET_NODIE(A,XEmitter,FinishedSpawningTrigger)
//VERIFY_CLASS_OFFSET_NODIE(A,XEmitter,UseActorCoords)
//VERIFY_CLASS_OFFSET_NODIE(A,XEmitter,CoronaTexture)
//VERIFY_CLASS_OFFSET_NODIE(A,XEmitter,ParticleSpawnTag)
//VERIFY_CLASS_OFFSET_NODIE(A,XEmitter,ParticleKillTag)
//VERIFY_CLASS_OFFSET_NODIE(A,XEmitter,ParticleWallHitTag)
//VERIFY_CLASS_OFFSET_NODIE(A,XEmitter,ParticleLifeTimeTag)
//VERIFY_CLASS_OFFSET_NODIE(A,XEmitter,ForcesTags)
//VERIFY_CLASS_OFFSET_NODIE(A,XEmitter,SpawnCombiners)
//VERIFY_CLASS_OFFSET_NODIE(A,XEmitter,LifeTimeCombiners)
//VERIFY_CLASS_OFFSET_NODIE(A,XEmitter,DestructCombiners)
//VERIFY_CLASS_OFFSET_NODIE(A,XEmitter,WallHitCombiners)
//VERIFY_CLASS_OFFSET_NODIE(A,XEmitter,TSpawnC)
//VERIFY_CLASS_OFFSET_NODIE(A,XEmitter,TLifeTimeC)
//VERIFY_CLASS_OFFSET_NODIE(A,XEmitter,TDestructC)
//VERIFY_CLASS_OFFSET_NODIE(A,XEmitter,TWallHitC)
//VERIFY_CLASS_OFFSET_NODIE(A,XEmitter,RevolutionTimeScale)
//VERIFY_CLASS_OFFSET_NODIE(A,XEmitter,ParticleTextures)
//VERIFY_CLASS_OFFSET_NODIE(A,XEmitter,ParticleSpawnCClass)
//VERIFY_CLASS_OFFSET_NODIE(A,XEmitter,ParticleKillCClass)
//VERIFY_CLASS_OFFSET_NODIE(A,XEmitter,ParticleWallHitCClass)
//VERIFY_CLASS_OFFSET_NODIE(A,XEmitter,ParticleLifeTimeCClass)
//VERIFY_CLASS_OFFSET_NODIE(A,XEmitter,TimeScale)
//VERIFY_CLASS_OFFSET_NODIE(A,XEmitter,TimeDrawScale3D)
//VERIFY_CLASS_OFFSET_NODIE(A,XEmitter,SpeedScale)
//VERIFY_CLASS_OFFSET_NODIE(A,XEmitter,SpeedTimeScale3D)
//VERIFY_CLASS_OFFSET_NODIE(A,XEmitter,ForcesList)
//VERIFY_CLASS_OFFSET_NODIE(A,XEmitter,ParticleColorScale)
//VERIFY_CLASS_OFFSET_NODIE(A,XEmitter,CacheRot)
//VERIFY_CLASS_OFFSET_NODIE(A,XEmitter,OldSpawnPosition)
//VERIFY_CLASS_OFFSET_NODIE(A,XEmitter,RendBoundingBox)
//VERIFY_CLASS_OFFSET_NODIE(A,XEmitter,LifetimeRange)
//VERIFY_CLASS_OFFSET_NODIE(A,XEmitter,AutoResetTime)
//VERIFY_CLASS_OFFSET_NODIE(A,XEmitter,RevolutionOffset)
//VERIFY_CLASS_OFFSET_NODIE(A,XEmitter,RevolutionsPerSec)
//VERIFY_CLASS_OFFSET_NODIE(A,XEmitter,RevolutionOffsetUnAxis)
//VERIFY_CLASS_OFFSET_NODIE(A,XEmitter,CombinedParticleCount)
//VERIFY_CLASS_OFFSET_NODIE(A,XEmitter,ParticleLifeTimeSDelay)
//VERIFY_CLASS_OFFSET_NODIE(A,XEmitter,StartingScale)
//VERIFY_CLASS_OFFSET_NODIE(A,XEmitter,Scale3DRange)
//VERIFY_CLASS_OFFSET_NODIE(A,XEmitter,VisibilityBox)
//VERIFY_CLASS_OFFSET_NODIE(A,XEmitter,BoxLocation)
//VERIFY_CLASS_OFFSET_NODIE(A,XEmitter,SphereCylinderRange)
//VERIFY_CLASS_OFFSET_NODIE(A,XEmitter,SpawnOffsetMultiplier)
//VERIFY_CLASS_OFFSET_NODIE(A,XEmitter,VertexLimitBBox)
//VERIFY_CLASS_OFFSET_NODIE(A,XEmitter,SpawnParts)
//VERIFY_CLASS_OFFSET_NODIE(A,XEmitter,ParticleAcceleration)
//VERIFY_CLASS_OFFSET_NODIE(A,XEmitter,BoxVelocity)
//VERIFY_CLASS_OFFSET_NODIE(A,XEmitter,SphereCylVelocity)
//VERIFY_CLASS_OFFSET_NODIE(A,XEmitter,VelocityLossRate)
//VERIFY_CLASS_OFFSET_NODIE(A,XEmitter,ParticleExtent)
//VERIFY_CLASS_OFFSET_NODIE(A,XEmitter,ParticleBounchyness)
//VERIFY_CLASS_OFFSET_NODIE(A,XEmitter,ImpactSound)
//VERIFY_CLASS_OFFSET_NODIE(A,XEmitter,SpawnSound)
//VERIFY_CLASS_OFFSET_NODIE(A,XEmitter,DestroySound)
//VERIFY_CLASS_OFFSET_NODIE(A,XEmitter,ParticleColor)
//VERIFY_CLASS_OFFSET_NODIE(A,XEmitter,CoronaColor)
//VERIFY_CLASS_OFFSET_NODIE(A,XEmitter,CoronaOffset)
//VERIFY_CLASS_OFFSET_NODIE(A,XEmitter,ParticleStyle)
//VERIFY_CLASS_OFFSET_NODIE(A,XEmitter,FadeStyle)
//VERIFY_CLASS_OFFSET_NODIE(A,XEmitter,SpriteAnimationType)
//VERIFY_CLASS_OFFSET_NODIE(A,XEmitter,SpawnPosType)
//VERIFY_CLASS_OFFSET_NODIE(A,XEmitter,TriggerAction)
//VERIFY_CLASS_OFFSET_NODIE(A,XEmitter,SpawnVelType)
//VERIFY_CLASS_OFFSET_NODIE(A,XEmitter,ParticleCollision)
//VERIFY_CLASS_OFFSET_NODIE(A,XEmitter,WallImpactAction)
//VERIFY_CLASS_OFFSET_NODIE(A,XEmitter,WaterImpactAction)
VERIFY_CLASS_SIZE_NODIE(AXEmitter)
//VERIFY_CLASS_OFFSET_NODIE(A,XSpriteEmitter,RotateByVelocityScale)
//VERIFY_CLASS_OFFSET_NODIE(A,XSpriteEmitter,SheetModel)
//VERIFY_CLASS_OFFSET_NODIE(A,XSpriteEmitter,RotationsPerSec)
//VERIFY_CLASS_OFFSET_NODIE(A,XSpriteEmitter,InitialRot)
//VERIFY_CLASS_OFFSET_NODIE(A,XSpriteEmitter,RotNormal)
//VERIFY_CLASS_OFFSET_NODIE(A,XSpriteEmitter,ParticleRotation)
VERIFY_CLASS_SIZE_NODIE(AXSpriteEmitter)
//VERIFY_CLASS_OFFSET_NODIE(A,XMeshEmitter,PartAnimRate)
//VERIFY_CLASS_OFFSET_NODIE(A,XMeshEmitter,PartAnimFrameStart)
//VERIFY_CLASS_OFFSET_NODIE(A,XMeshEmitter,ParticleMesh)
//VERIFY_CLASS_OFFSET_NODIE(A,XMeshEmitter,AnimateByActor)
//VERIFY_CLASS_OFFSET_NODIE(A,XMeshEmitter,ParticleAnim)
//VERIFY_CLASS_OFFSET_NODIE(A,XMeshEmitter,RandAnims)
//VERIFY_CLASS_OFFSET_NODIE(A,XMeshEmitter,ParticleFatness)
//VERIFY_CLASS_OFFSET_NODIE(A,XMeshEmitter,RotationsPerSec)
//VERIFY_CLASS_OFFSET_NODIE(A,XMeshEmitter,InitialRot)
//VERIFY_CLASS_OFFSET_NODIE(A,XMeshEmitter,ParticleRotation)
VERIFY_CLASS_SIZE_NODIE(AXMeshEmitter)
//VERIFY_CLASS_OFFSET_NODIE(A,EmitterGarbageCollector,CleanUpTime)
//VERIFY_CLASS_OFFSET_NODIE(A,EmitterGarbageCollector,GarbagePtr)
VERIFY_CLASS_SIZE_NODIE(AEmitterGarbageCollector)
//VERIFY_CLASS_OFFSET_NODIE(U,ScriptPostRenderRI,CallingObject)
//VERIFY_CLASS_OFFSET_NODIE(U,ScriptPostRenderRI,ScriptRenderFunct)
VERIFY_CLASS_SIZE_NODIE(UScriptPostRenderRI)
//VERIFY_CLASS_OFFSET_NODIE(U,EmitterRendering,LastUpdateTime)
//VERIFY_CLASS_OFFSET_NODIE(U,EmitterRendering,PartPtr)
VERIFY_CLASS_SIZE_NODIE(UEmitterRendering)
//VERIFY_CLASS_OFFSET_NODIE(A,VelocityForce,VelocityToAdd)
VERIFY_CLASS_SIZE_NODIE(AVelocityForce)
//VERIFY_CLASS_OFFSET_NODIE(A,XParticleForces,EffectingRadius)
//VERIFY_CLASS_OFFSET_NODIE(A,XParticleForces,OldTagName)
//VERIFY_CLASS_OFFSET_NODIE(A,XParticleForces,EffectingBox)
//VERIFY_CLASS_OFFSET_NODIE(A,XParticleForces,EffectPartLifeTime)
VERIFY_CLASS_SIZE_NODIE(AXParticleForces)
//VERIFY_CLASS_OFFSET_NODIE(A,ParticleConcentrateForce,DrainSpeed)
//VERIFY_CLASS_OFFSET_NODIE(A,ParticleConcentrateForce,MaxDistance)
//VERIFY_CLASS_OFFSET_NODIE(A,ParticleConcentrateForce,CenterPointOffset)
VERIFY_CLASS_SIZE_NODIE(AParticleConcentrateForce)
//VERIFY_CLASS_OFFSET_NODIE(A,KillParticleForce,LifeTimeDrainAmount)
VERIFY_CLASS_SIZE_NODIE(AKillParticleForce)
//VERIFY_CLASS_OFFSET_NODIE(A,XBeamEmitter,NoiseSwapTime)
//VERIFY_CLASS_OFFSET_NODIE(A,XBeamEmitter,TextureUV)
//VERIFY_CLASS_OFFSET_NODIE(A,XBeamEmitter,TurnRate)
//VERIFY_CLASS_OFFSET_NODIE(A,XBeamEmitter,StartTexture)
//VERIFY_CLASS_OFFSET_NODIE(A,XBeamEmitter,EndTexture)
//VERIFY_CLASS_OFFSET_NODIE(A,XBeamEmitter,RenderDataModel)
//VERIFY_CLASS_OFFSET_NODIE(A,XBeamEmitter,BeamTarget)
//VERIFY_CLASS_OFFSET_NODIE(A,XBeamEmitter,NoiseTimeScale)
//VERIFY_CLASS_OFFSET_NODIE(A,XBeamEmitter,BeamPointScaling)
//VERIFY_CLASS_OFFSET_NODIE(A,XBeamEmitter,SegmentScales)
//VERIFY_CLASS_OFFSET_NODIE(A,XBeamEmitter,NoiseRange)
//VERIFY_CLASS_OFFSET_NODIE(A,XBeamEmitter,BeamTargetType)
//VERIFY_CLASS_OFFSET_NODIE(A,XBeamEmitter,Segments)
VERIFY_CLASS_SIZE_NODIE(AXBeamEmitter)
VERIFY_CLASS_SIZE_NODIE(AEmitterRC)
//VERIFY_CLASS_OFFSET_NODIE(U,ActorFaceCameraRI,RotationModifier)
VERIFY_CLASS_SIZE_NODIE(UActorFaceCameraRI)
//VERIFY_CLASS_OFFSET_NODIE(A,DistantLightActor,NewLightRadius)
