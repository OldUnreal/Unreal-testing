...
//VERIFY_CLASS_OFFSET_NODIE(A,PawnPathNodeIterator,Pawn)
VERIFY_CLASS_SIZE_NODIE(APawnPathNodeIterator)
//VERIFY_CLASS_OFFSET_NODIE(A,PathNodeIterator,NodeCount)
//VERIFY_CLASS_OFFSET_NODIE(A,PathNodeIterator,NodeIndex)
//VERIFY_CLASS_OFFSET_NODIE(A,PathNodeIterator,NodeCost)
//VERIFY_CLASS_OFFSET_NODIE(A,PathNodeIterator,NodePath)
//VERIFY_CLASS_OFFSET_NODIE(A,PathNodeIterator,NodeStart)
