...
#exec TEXTURE IMPORT NAME=ActiveFrame FILE=Textures\ActiveFrame.pcx GROUP="Icons" FLAGS=2 MIPS=OFF
#exec TEXTURE IMPORT NAME=InactiveFrame FILE=Textures\InactiveFrame.pcx GROUP="Icons" FLAGS=2 MIPS=OFF
#exec TEXTURE IMPORT NAME=ActiveFrameS FILE=Textures\ActiveFrameS.pcx GROUP="Icons" FLAGS=2 MIPS=OFF
#exec TEXTURE IMPORT NAME=InactiveFrameS FILE=Textures\InactiveFrameS.pcx GROUP="Icons" FLAGS=2 MIPS=OFF

#exec TEXTURE IMPORT NAME=Misc FILE=Textures\Misc.pcx GROUP="Icons" MIPS=OFF

#exec TEXTURE IMPORT NAME=ChkChecked FILE=Textures\ChkChecked.pcx GROUP="Icons" FLAGS=2 MIPS=OFF
#exec TEXTURE IMPORT NAME=ChkUnchecked FILE=Textures\ChkUnchecked.pcx GROUP="Icons" FLAGS=2 MIPS=OFF
#exec TEXTURE IMPORT NAME=ChkCheckedDisabled FILE=Textures\ChkCheckedDisabled.pcx GROUP="Icons" FLAGS=2 MIPS=OFF
#exec TEXTURE IMPORT NAME=ChkUncheckedDisabled FILE=Textures\ChkUncheckedDisabled.pcx GROUP="Icons" FLAGS=2 MIPS=OFF

#exec TEXTURE IMPORT NAME=MenuBar FILE=Textures\MenuBar.pcx GROUP="Icons" MIPS=OFF
#exec TEXTURE IMPORT NAME=MenuHighlightL FILE=Textures\MenuHighlightL.pcx FLAGS=2 GROUP="Icons" MIPS=OFF
#exec TEXTURE IMPORT NAME=MenuHighlightM FILE=Textures\MenuHighlightM.pcx FLAGS=2 GROUP="Icons" MIPS=OFF
#exec TEXTURE IMPORT NAME=MenuHighlightR FILE=Textures\MenuHighlightR.pcx FLAGS=2 GROUP="Icons" MIPS=OFF

#exec TEXTURE IMPORT NAME=MenuArea FILE=Textures\MenuArea.pcx GROUP="Icons" MIPS=OFF
#exec TEXTURE IMPORT NAME=MenuTL FILE=Textures\MenuTL.pcx GROUP="Icons" MIPS=OFF
#exec TEXTURE IMPORT NAME=MenuT FILE=Textures\MenuT.pcx GROUP="Icons" MIPS=OFF
#exec TEXTURE IMPORT NAME=MenuTR FILE=Textures\MenuTR.pcx GROUP="Icons" MIPS=OFF
#exec TEXTURE IMPORT NAME=MenuL FILE=Textures\MenuL.pcx GROUP="Icons" MIPS=OFF
#exec TEXTURE IMPORT NAME=MenuR FILE=Textures\MenuR.pcx GROUP="Icons" MIPS=OFF
#exec TEXTURE IMPORT NAME=MenuBL FILE=Textures\MenuBL.pcx GROUP="Icons" MIPS=OFF
#exec TEXTURE IMPORT NAME=MenuB FILE=Textures\MenuB.pcx GROUP="Icons" MIPS=OFF
#exec TEXTURE IMPORT NAME=MenuBR FILE=Textures\MenuBR.pcx GROUP="Icons" MIPS=OFF
#exec TEXTURE IMPORT NAME=MenuHighlight FILE=Textures\MenuHighlight.pcx GROUP="Icons" MIPS=OFF
...
{
	W.DrawStretchedTextureSegment(C, 0, 0, W.WinWidth, W.WinHeight, 0, 0, 1, 1, Texture'MenuHighlightL');
}
...
function Tab_DrawTab(UWindowTabControlTabArea Tab, Canvas C, bool bActiveTab, bool bLeftmostTab, float X, float Y, float W, float H, string Text, bool bShowText)
{
	...
	if (bActiveTab)
	{
		...
		if (bShowText)
		{
			...
			Tab.ClipText(C, X + (W-TW)/2, Y + 2, Text, True);
		}
	}
	else
	{
...
// Added on 227 to fix errors:
function Button_DrawSmallButton(UWindowSmallButton B, Canvas C)
{
	B.DrawStretchedTextureSegment(C, 0, 0, 3, 16, 4, 16, 3, 16, Texture'ActiveFrame');
	B.DrawStretchedTextureSegment(C, B.WinWidth - 3, 0, 3, 16, 17, 16, 3, 16, Texture'ActiveFrame');
	B.DrawStretchedTextureSegment(C, 3, 0, B.WinWidth-6, 16, 8, 16, 1, 16, Texture'ActiveFrame');
}
