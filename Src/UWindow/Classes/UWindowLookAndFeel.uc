...
var() Color		EditBoxDisabledTextColor;
...
var() UnrealCursor MousePointers[8];
...
defaultproperties
{
	EditBoxDisabledTextColor=(R=128,G=128,B=128,A=0)
	
	Begin Object Class=UnrealCursor Name=Cursor_Normal
		Frames(0)=Texture'MouseCursor'
		FallbackCursor=Player.IDC_ARROW
	End Object
	MousePointers(0)=Cursor_Normal
	
	Begin Object Class=UnrealCursor Name=Cursor_SizeAll
		Frames(0)=Texture'MouseMove'
		HotSpotX=8
		HotSpotY=8
		FallbackCursor=Player.IDC_SIZEALL
	End Object
	MousePointers(1)=Cursor_SizeAll
	
	Begin Object Class=UnrealCursor Name=Cursor_SizeNESW
		Frames(0)=Texture'MouseDiag2'
		HotSpotX=7
		HotSpotY=7
		FallbackCursor=Player.IDC_SIZENESW
	End Object
	MousePointers(2)=Cursor_SizeNESW
	
	Begin Object Class=UnrealCursor Name=Cursor_SizeNS
		Frames(0)=Texture'MouseVSplit'
		HotSpotX=9
		HotSpotY=9
		FallbackCursor=Player.IDC_SIZENS
	End Object
	MousePointers(3)=Cursor_SizeNS
	
	Begin Object Class=UnrealCursor Name=Cursor_SizeNWSE
		Frames(0)=Texture'MouseDiag1'
		HotSpotX=8
		HotSpotY=8
		FallbackCursor=Player.IDC_SIZENWSE
	End Object
	MousePointers(4)=Cursor_SizeNWSE
	
	Begin Object Class=UnrealCursor Name=Cursor_SizeWE
		Frames(0)=Texture'MouseHSplit'
		HotSpotX=9
		HotSpotY=9
		FallbackCursor=Player.IDC_SIZEWE
	End Object
	MousePointers(5)=Cursor_SizeWE
	
	Begin Object Class=UnrealCursor Name=Cursor_Wait
		Frames(0)=Texture'MouseWait'
		HotSpotX=6
		HotSpotY=9
		FallbackCursor=Player.IDC_WAIT
	End Object
	MousePointers(6)=Cursor_Wait
	
	Begin Object Class=UnrealCursor Name=Cursor_Hand
		Frames(0)=Texture'MouseHand'
		HotSpotX=11
		HotSpotY=1
		FallbackCursor=Player.IDC_ARROW
	End Object
	MousePointers(7)=Cursor_Hand
}