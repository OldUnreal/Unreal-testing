...
function LeftClickRowDown(int Row, float X, float Y);  // pressing left mouse button when pointing to the row
function LeftClickRow(int Row, float X, float Y);      // releasing left mouse button when pointing to the row
function RightClickRowDown(int Row, float X, float Y); // pressing right mouse button when pointing to the row
function RightClickRow(int Row, float X, float Y);     // releasing right mouse button when pointing to the row
