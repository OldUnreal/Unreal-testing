...
#exec MESH NOTIFY MESH=Female1 SEQ=Walk TIME=0.25 FUNCTION=PlayFootStep
#exec MESH NOTIFY MESH=Female1 SEQ=Walk TIME=0.75 FUNCTION=PlayFootStep
...
#exec MESH SOCKET MESH=Female1 SOCKETNAME="L_Hand" VERT0=119 VERT1=61 VERT2=193 X=-1 Y=2 Z=2 PITCH=-25 YAW=11 ROLL=64
#exec MESH SOCKET MESH=Female1 SOCKETNAME="Head" VERT0=167 VERT1=37 VERT2=63 X=0.5 Y=-0.25 Z=-0.5 PITCH=-3 YAW=0 ROLL=0
