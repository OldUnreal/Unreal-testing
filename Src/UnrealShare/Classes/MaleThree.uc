...
#exec MESH NOTIFY MESH=Male3 SEQ=Walk TIME=0.25 FUNCTION=PlayFootStep
#exec MESH NOTIFY MESH=Male3 SEQ=Walk TIME=0.75 FUNCTION=PlayFootStep
...
#exec MESH SOCKET MESH=Male3 SOCKETNAME="L_Hand" VERT0=264 VERT1=39 VERT2=40 PITCH=-18 YAW=23 ROLL=85
#exec MESH SOCKET MESH=Male3 SOCKETNAME="Head" VERT0=111 VERT1=129 VERT2=76 X=0 Y=0 Z=-8 PITCH=6 YAW=0 ROLL=0
