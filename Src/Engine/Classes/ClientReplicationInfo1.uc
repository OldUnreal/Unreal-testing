// ClientReplicationInfo1 - implementation of interface ClientReplicationInfo - version 1
//
...
// such a variable should be added in a similar struct inside a new class - ClientReplicationInfo2
// derived directly from ClientReplicationInfo (this may imply copy-pasting the whole class implementation)
// in order to maintain interoperability with older versions.
//
class ClientReplicationInfo1 expands ClientReplicationInfo
	nousercreate;
...
static final function bool IsSupportedByClient(PlayerPawn Player)
{
	return
		Player.GetNegotiatedVersion() >= 227 &&
