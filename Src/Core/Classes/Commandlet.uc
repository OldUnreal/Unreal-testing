...
/// Whether to disable localization (f.e. for make commandlet).
var bool ForceInt;

// Avoid infinite script recursion when calling Main.
var const bool bMainEntry;

/// Entry point.
native event int Main( string InParms );
