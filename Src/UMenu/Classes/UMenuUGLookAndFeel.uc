class UMenuUGLookAndFeel extends UWindowLookAndFeel;

#exec TEXTURE IMPORT NAME=UGActiveFrame FILE=Textures\G_ActiveFrame.pcx GROUP="Icons" FLAGS=2 MIPS=OFF
#exec TEXTURE IMPORT NAME=UGInactiveFrame FILE=Textures\G_InactiveFrame.pcx GROUP="Icons" FLAGS=2 MIPS=OFF
#exec TEXTURE IMPORT NAME=UGActiveFrameS FILE=Textures\G_ActiveFrameS.pcx GROUP="Icons" FLAGS=2 MIPS=OFF
#exec TEXTURE IMPORT NAME=UGInactiveFrameS FILE=Textures\G_InactiveFrameS.pcx GROUP="Icons" FLAGS=2 MIPS=OFF

#exec TEXTURE IMPORT NAME=UGMisc FILE=Textures\G_Misc.pcx GROUP="Icons" MIPS=OFF
#exec TEXTURE IMPORT NAME=UGButton FILE=Textures\G_SmallButton.pcx GROUP="Icons" MIPS=OFF

#exec TEXTURE IMPORT NAME=UGMenuArea FILE=Textures\G_MenuArea.pcx GROUP="Icons" MIPS=OFF
#exec TEXTURE IMPORT NAME=UGClientArea FILE=Textures\G_ClientArea.pcx GROUP="Icons" MIPS=OFF
#exec TEXTURE IMPORT NAME=UGMenuTL FILE=Textures\G_MenuTL.pcx GROUP="Icons" MIPS=OFF
#exec TEXTURE IMPORT NAME=UGMenuT FILE=Textures\G_MenuT.pcx GROUP="Icons" MIPS=OFF
#exec TEXTURE IMPORT NAME=UGMenuTR FILE=Textures\G_MenuTR.pcx GROUP="Icons" MIPS=OFF
#exec TEXTURE IMPORT NAME=UGMenuL FILE=Textures\G_MenuL.pcx GROUP="Icons" MIPS=OFF
#exec TEXTURE IMPORT NAME=UGMenuR FILE=Textures\G_MenuR.pcx GROUP="Icons" MIPS=OFF
#exec TEXTURE IMPORT NAME=UGMenuBL FILE=Textures\G_MenuBL.pcx GROUP="Icons" MIPS=OFF
#exec TEXTURE IMPORT NAME=UGMenuB FILE=Textures\G_MenuB.pcx GROUP="Icons" MIPS=OFF
#exec TEXTURE IMPORT NAME=UGMenuBR FILE=Textures\G_MenuBR.pcx GROUP="Icons" MIPS=OFF
#exec TEXTURE IMPORT NAME=UGMenuHL FILE=Textures\G_MenuHL.pcx GROUP="Icons" MIPS=OFF
#exec TEXTURE IMPORT NAME=UGMenuHM FILE=Textures\G_MenuHM.pcx GROUP="Icons" MIPS=OFF
#exec TEXTURE IMPORT NAME=UGMenuHR FILE=Textures\G_MenuHR.pcx GROUP="Icons" MIPS=OFF
#exec TEXTURE IMPORT NAME=UGMenuLine FILE=Textures\G_MenuLine.pcx GROUP="Icons" MIPS=OFF

#exec TEXTURE IMPORT NAME=UGBarL FILE=Textures\G_BarL.pcx GROUP="Icons" MIPS=OFF
#exec TEXTURE IMPORT NAME=UGBarTile FILE=Textures\G_BarTile.pcx GROUP="Icons" MIPS=OFF
#exec TEXTURE IMPORT NAME=UGBarMax FILE=Textures\G_BarMax.pcx GROUP="Icons" MIPS=OFF
#exec TEXTURE IMPORT NAME=UGBarWin FILE=Textures\G_BarWin.pcx GROUP="Icons" MIPS=OFF


#exec TEXTURE IMPORT NAME=UGBarInL FILE=Textures\G_BarInL.pcx GROUP="Icons" MIPS=OFF
#exec TEXTURE IMPORT NAME=UGBarInR FILE=Textures\G_BarInR.pcx GROUP="Icons" MIPS=OFF
#exec TEXTURE IMPORT NAME=UGBarInM FILE=Textures\G_BarInM.pcx GROUP="Icons" MIPS=OFF

#exec TEXTURE IMPORT NAME=UGBarOutL FILE=Textures\G_BarOutL.pcx GROUP="Icons" MIPS=OFF
#exec TEXTURE IMPORT NAME=UGBarOutR FILE=Textures\G_BarOutR.pcx GROUP="Icons" MIPS=OFF
#exec TEXTURE IMPORT NAME=UGBarOutM FILE=Textures\G_BarOutM.pcx GROUP="Icons" MIPS=OFF
...
{
	W.DrawClippedTexture(C, 0, 0, Texture'UGMenuTL');
	W.DrawStretchedTexture(C, 2, 0, W.WinWidth-4, 2, Texture'UGMenuT');
	W.DrawClippedTexture(C, W.WinWidth-2, 0, Texture'UGMenuTR');

	W.DrawClippedTexture(C, 0, W.WinHeight-2, Texture'UGMenuBL');
	W.DrawStretchedTexture(C, 2, W.WinHeight-2, W.WinWidth-4, 2, Texture'UGMenuB');
	W.DrawClippedTexture(C, W.WinWidth-2, W.WinHeight-2, Texture'UGMenuBR');

	W.DrawStretchedTexture(C, 0, 2, 2, W.WinHeight-4, Texture'UGMenuL');
	W.DrawStretchedTexture(C, W.WinWidth-2, 2, 2, W.WinHeight-4, Texture'UGMenuR');

	W.DrawStretchedTexture(C, 2, 2, W.WinWidth-4, W.WinHeight-4, Texture'UGClientArea');
}
...
{
	W.DrawClippedTexture(C, 0, 0, Texture'UMenu.UGMenuTL');
	W.DrawStretchedTexture(C, 4, 0, W.WinWidth-8, 4, Texture'UMenu.UGMenuT');
	W.DrawClippedTexture(C, W.WinWidth-4, 0, Texture'UMenu.UGMenuTR');

	W.DrawClippedTexture(C, 0, W.WinHeight-4, Texture'UMenu.UGMenuBL');
	W.DrawStretchedTexture(C, 4, W.WinHeight-4, W.WinWidth-8, 4, Texture'UMenu.UGMenuB');
	W.DrawClippedTexture(C, W.WinWidth-4, W.WinHeight-4, Texture'UMenu.UGMenuBR');

	W.DrawStretchedTexture(C, 0, 4, 4, W.WinHeight-8, Texture'UMenu.UGMenuL');
	W.DrawStretchedTexture(C, W.WinWidth-4, 4, 4, W.WinHeight-8, Texture'UMenu.UGMenuR');

	W.DrawStretchedTexture(C, 4, 4, W.WinWidth-8, W.WinHeight-8, Texture'UMenu.UGMenuArea');
}
...
function ComboList_DrawItem(UWindowComboList Combo, Canvas C, float X, float Y, float W, float H, string Text, bool bSelected)
{
	...
	if(bSelected)
	{
		Combo.DrawClippedTexture(C, X, Y, Texture'UMenu.UGMenuHL');
		Combo.DrawStretchedTexture(C, X + 4, Y, W - 8, 16, Texture'UMenu.UGMenuHM');
		Combo.DrawClippedTexture(C, X + W - 4, Y, Texture'UMenu.UGMenuHR');
		C.DrawColor.R = 0;
		C.DrawColor.G = 0;
		C.DrawColor.B = 0;
	}
...
{
	W.DrawClippedTexture(C, 0, 0, Texture'UMenu.UGBarL');
	W.DrawStretchedTexture( C, 16, 0, W.WinWidth - 32, 16, Texture'UMenu.UGBarTile');
	W.DrawClippedTexture(C, W.WinWidth - 16, 0, Texture'UMenu.UGBarWin');
}
...
function Menu_DrawMenuBarItem(UWindowMenuBar B, UWindowMenuBarItem I, float X, float Y, float W, float H, Canvas C)
{
	if(B.Selected == I)
	{
		B.DrawClippedTexture(C, X, 0, Texture'UGBarInL');
		B.DrawClippedTexture(C, X+W-1, 0, Texture'UGBarInR');
		B.DrawStretchedTexture(C, X+1, 0, W-2, 16, Texture'UGBarInM');
	}
	else
	if (B.Over == I)
	{
		B.DrawClippedTexture(C, X, 0, Texture'UGBarOutL');
		B.DrawClippedTexture(C, X+W-1, 0, Texture'UGBarOutR');
		B.DrawStretchedTexture(C, X+1, 0, W-2, 16, Texture'UGBarOutM');
	}
...
function Menu_DrawPulldownMenuItem(UWindowPulldownMenu M, UWindowPulldownMenuItem Item, Canvas C, float X, float Y, float W, float H, bool bSelected)
{
	...
	if(Item.Caption == "-")
	{
		...
		C.DrawColor.G = 255;
		C.DrawColor.B = 255;
		M.DrawStretchedTexture(C, X, Y+5, W, 2, Texture'UMenu.UGMenuLine');
		return;
	}
	...
	if(bSelected)
	{
		M.DrawClippedTexture(C, X, Y, Texture'UMenu.UGMenuHL');
		M.DrawStretchedTexture(C, X + 4, Y, W - 8, 16, Texture'UMenu.UGMenuHM');
		M.DrawClippedTexture(C, X + W - 4, Y, Texture'UMenu.UGMenuHR');
	}
...
function Button_DrawSmallButton(UWindowSmallButton B, Canvas C)
{
	...
	B.DrawStretchedTextureSegment(C, 0, 0, 3, 16, 0, Y, 3, 16, Texture'UGButton');
	B.DrawStretchedTextureSegment(C, B.WinWidth - 3, 0, 3, 16, 45, Y, 3, 16, Texture'UGButton');
	B.DrawStretchedTextureSegment(C, 3, 0, B.WinWidth-6, 16, 3, Y, 42, 16, Texture'UGButton');
}
...
defaultproperties
{
     ...
     CloseBoxOffsetX=2
     CloseBoxOffsetY=2
     Active=Texture'UMenu.Icons.UGActiveFrame'
     Inactive=Texture'UMenu.Icons.UGInactiveFrame'
     ActiveS=Texture'UMenu.Icons.UGActiveFrameS'
     InactiveS=Texture'UMenu.Icons.UGInactiveFrameS'
     Misc=Texture'UMenu.Icons.UGMisc'
     FrameTL=(W=2,H=16)
