...
var(BrushBuilder) Texture BitmapImage; // Must be a 32x32 P8 texture that's cropped 2 pixels off by bottom/right sides (so its drawn as 30x30).
var(BrushBuilder) string BitmapFilename; // Alternatively a bmp file in System/editorres folder.
