...
#exec Texture Import File=Textures\BBCurvedStair.pcx Name=BB_CurvedStair Mips=Off Flags=2
...
function bool Build()
{
	...
	if ( InnerRadius<1 || StepWidth<1 || NumSteps<1 || StepHeight<1 )
...
defaultproperties
{
	...
	CounterClockwise=0
	AddToFirstStep=0
	BitmapImage=Texture'BB_CurvedStair'
