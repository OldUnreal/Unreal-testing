...
#exec Texture Import File=Textures\BBSphere.pcx Name=BB_Sphere Mips=Off Flags=2
...
event bool Build()
{
	if ( Radius<=0 || SphereExtrapolation<=0 || SphereExtrapolation>5 )
