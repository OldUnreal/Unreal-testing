...
#exec MESH NOTIFY MESH=Female2 SEQ=Walk TIME=0.25 FUNCTION=PlayFootStep
#exec MESH NOTIFY MESH=Female2 SEQ=Walk TIME=0.75 FUNCTION=PlayFootStep
...
#exec MESH SOCKET MESH=Female2 SOCKETNAME="L_Hand" VERT0=119 VERT1=92 VERT2=193 X=-2.5 Y=2 Z=-2 PITCH=-28 YAW=-4 ROLL=64
#exec MESH SOCKET MESH=Female2 SOCKETNAME="Head" VERT0=116 VERT1=163 VERT2=70 X=-0.75 Y=0 Z=-1 PITCH=3 YAW=0 ROLL=0
