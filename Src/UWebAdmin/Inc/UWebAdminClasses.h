...
//VERIFY_CLASS_OFFSET_NODIE(U,WebPageContent,RequiredPrivileges)
VERIFY_CLASS_SIZE_NODIE(UWebPageContent)
//VERIFY_CLASS_OFFSET_NODIE(U,WebQuery,DataSize)
//VERIFY_CLASS_OFFSET_NODIE(U,WebQuery,PendingCount)
//VERIFY_CLASS_OFFSET_NODIE(U,WebQuery,Connection)
//VERIFY_CLASS_OFFSET_NODIE(U,WebQuery,Manager)
//VERIFY_CLASS_OFFSET_NODIE(U,WebQuery,Data)
//VERIFY_CLASS_OFFSET_NODIE(U,WebQuery,PendingSend)
//VERIFY_CLASS_OFFSET_NODIE(U,WebQuery,User)
//VERIFY_CLASS_OFFSET_NODIE(U,WebQuery,Password)
//VERIFY_CLASS_OFFSET_NODIE(U,WebQuery,URL)
//VERIFY_CLASS_OFFSET_NODIE(U,WebQuery,Header)
//VERIFY_CLASS_OFFSET_NODIE(U,WebQuery,UpFileName)
//VERIFY_CLASS_OFFSET_NODIE(U,WebQuery,FileTrailing)
//VERIFY_CLASS_OFFSET_NODIE(U,WebQuery,ContentType)
//VERIFY_CLASS_OFFSET_NODIE(U,WebQuery,MiscInfo)
//VERIFY_CLASS_OFFSET_NODIE(U,WebQuery,DataMap)
//VERIFY_CLASS_OFFSET_NODIE(U,WebQuery,UserPrivileges)
//VERIFY_CLASS_OFFSET_NODIE(U,WebQuery,PendingData)
