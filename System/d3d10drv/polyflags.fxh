...
#define PF_ForceViewZone	 0x00004000	// Force current iViewZone in OccludeBSP (reuse Flat flag)
...
#define PF_AlphaBlend 		 0x00020000	// This poly should be alpha blended
...
#define PF_NoBoundRejection  0x00200000	// Disable bound rejection in OccludeBSP (reuse Gourard flag)
...
#define PF_NoOcclude		 PF_Masked | PF_Translucent | PF_Invisible | PF_Modulated | PF_AlphaBlend
...
#define PF_NoShadows		 PF_Unlit | PF_Invisible | PF_FakeBackdrop
